  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-14 sm:px-6 lg:px-8">
      <div className="rounded-3xl border border-amber-200 bg-amber-50/60 p-8">
        <h1 className="text-2xl font-extrabold text-[#4D321E]">Couldn’t load this product</h1>
        <p className="mt-2 text-sm text-[#6B4C3B]">Please try again or return to the product list.</p>
