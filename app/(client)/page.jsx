    ...
    <>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-2xl font-extrabold text-[#4D321E]">Browse by Category</h2>
        ...
        <div className="flex flex-wrap gap-2">
          {categories.length > 0 ? (
            ...
            <p className="text-sm text-[#8A6D5E]">Categories will appear once they are added.</p>
          )}
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-14 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-extrabold text-[#4D321E]">Fresh Today</h2>
          <Link href="/products" className="text-sm font-semibold text-amber-700 hover:text-amber-800">
            Shop All Products
          </Link>
        </div>
        ...
        {featuredProducts.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-amber-200 bg-amber-50/60 p-12 text-center">
            <p className="font-semibold text-[#6B4C3B]">No featured products available yet.</p>
          </div>
        )}
      </section>
    </>
