...
export default function OrderModal({ isOpen, onClose, order, onStatusChange, isUpdatingStatus }) {
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative flex flex-col w-full max-w-2xl md:max-w-3xl max-h-[90vh] sm:max-h-[85vh] animate-fade-up overflow-hidden rounded-3xl bg-white dark:bg-zinc-900 shadow-2xl border border-amber-50 dark:border-zinc-800">
        {/* Header */}
        <div className="flex shrink-0 items-center justify-between border-b border-amber-50 dark:border-zinc-800 px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-amber-50 dark:bg-zinc-800 text-amber-600 dark:text-amber-500">
              <ShoppingBag size={20} />
            </div>
            <div>
        ...
        {/* Footer with Total */}
        <div className="flex shrink-0 items-center justify-between border-t border-amber-50 dark:border-zinc-800 bg-amber-50/30 dark:bg-zinc-800/30 px-6 py-4 sm:py-5">
